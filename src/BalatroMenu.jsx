...
const BalatroMenu = () => {
  ...
  return (
    <div className="balatro-container">
      ...
      {/* Versión en la esquina superior derecha */}
      <div className="version">1.0.1o-FULL</div>

      {/* Contenido central */}
      <div className="menu-content">
        {/* Logo BALATRO */}
        <div className="logo-container">
          <img src="/letras.png" alt="BALATRO" className="logo-image" />
        </div>
      </div>

      {/* Footer con todo en la parte inferior */}
      <div className="bottom-section">
        <div className="left-section">
          <div className="profile-box">
            <div className="profile-label">Profile</div>
            <div className="profile-name-container">
              <div className="profile-name">StringBuilder</div>
            </div>
          </div>
        </div>
        ...
        <div className="right-section">
          <div className="social-icons">
            <button className="icon-btn discord">
